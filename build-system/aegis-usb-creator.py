...
EDITIONS = {
    "freemium": {
        ...
        "features": [
            "XFCE 4.18 Desktop",
            "AirDrop / Quick Share (LocalSend)",
            "Steam + Basic Proton Support",
            "RetroArch Emulator",
            "Aegis Game Library (Basic)",
            "Community Support"
        ],
    ...
    "basic": {
        "name": "Aegis OS Basic",
        "display_name": "Basic ($19 Lifetime)",
        "size_gb": 2.0,
    ...
    "workplace": {
        ...
        "display_name": "Workplace ($9 Lifetime)",
        "size_gb": 2.2,
    ...
    "gamer": {
        ...
        "features": [
            ...
            "AirDrop / Quick Share",
            "Steam, Lutris, Heroic Launchers",
            "Dual GPU + Upscaling (FSR/DLSS)",
            "StreamForge Capture Stack",
    ...
    "ai-dev": {
        ...
        "display_name": "AI Dev ($79 Lifetime)",
        "size_gb": 2.4,
        "size_bytes": 2576980377,
        "license_required": True,
        "license_prefix": "AIDV",
    ...
    "gamer-ai": {
        ...
        "display_name": "Gamer + AI ($119 Lifetime)",
        "size_gb": 2.4,
        "size_bytes": 2576980377,
        "license_required": True,
        "license_prefix": "GMAI",
