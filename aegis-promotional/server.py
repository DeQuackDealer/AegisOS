...
TIERS = {
    ...
    "gamer": {"lifetime": 49, "annual": 10, "features": ["base_os", "nvidia_driver", "amd_driver", "gaming_mode", "ray_tracing", "dlss3", "fsr3", "8k_upscaling", "rgb_ecosystem", "sub_1ms_latency", "dual_gpu_orchestration", "stream_studio", "anti_cheat_ready", "controller_config", "performance_overlay"], "users": "100", "api_limit": 5000},
